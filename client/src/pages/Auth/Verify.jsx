...
function Verify() {
    ...
    const getUser = async() => {
        ...
        if (data.error) {
            toast.error(data.error, {style: {background: '#ffffff', color: '#05345C'}});
            return;
        }
        ...
        <>
            <div className={styles.verify_root}>
                <div className={styles.verify_card}>
                    ...
                    <button className={styles.verify_button} onClick={getUser}>
                        Verify email address
                    </button>
                    <div className={styles.verify_divider}></div>
                    <p className={styles.verify_footer_note}>
                        This link is single-use and will expire after verification.
                    </p>
                </div>
            </div>
        </>
